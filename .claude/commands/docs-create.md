...
2. **检查内容**：
   - 代码示例中的 import 语句
   - 相对路径使用情况
   - MCP 相关的导入路径（@core/*, @transports/*, @cli/* 等）
...
- **MDX语法错误**：检查组件导入是否正确，避免使用不兼容的组件
- **导航配置错误**：确保新文档已在 docs.json 中正确配置
- **Mintlify配置问题**：检查 docs.json 文件的语法和结构
- **TypeScript配置问题**：检查文档中的TypeScript代码块语法
