...
<Tabs items={['正式版', 'Beta版', 'RC版']}>
  ...
  ```bash
  # Beta版发布
  pnpm release:skip-publish --version 1.10.8-beta.0
  ```
  ...
  ```bash
  # RC版发布
  pnpm release:skip-publish --version 1.10.8-rc.0
  ```
...
pnpm release:dry --version 1.10.8-beta.0
```
