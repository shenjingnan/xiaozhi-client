...
## 集成一个工作流
  ...
  <img style={{ margin: '10px 0'}} src="/images/coze-workflow/config-workflow-step-1.png" alt="第一步：点击右侧 **工作流集成** 按钮" />
  <img style={{ margin: '10px 0'}} src="/images/coze-workflow/config-workflow-step-2.png" alt="第二步：在指定的工作流中点击 添加 按钮" />
  <img style={{ margin: '10px 0'}} src="/images/coze-workflow/config-workflow-step-3.png" alt="第三步：在 配置工作流参数 弹窗中配置此工作流的参数" />
