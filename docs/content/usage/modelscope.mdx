...
由于 sse / http MCP 服务需要启动服务才能使用，但我们一般不太可能为每个 MCP 都启动一个 Docker。<br />
魔搭社区很好的解决了这个问题，其提供的 MCP 服务托管能力，可以帮助我们简化管理 sse / http MCP 服务的成本。
...
## 配置魔搭社区访问令牌
  ...
  <img style={{ margin: '10px 0'}} src="/images/modelscope/step-1.png" alt="第一步：点击 全局配置 菜单" />
  <img style={{ margin: '10px 0'}} src="/images/modelscope/step-2.png" alt="第二步：点击 打开魔搭社区 按钮 获取访问令牌" />

<Callout type="info">如果还没有访问令牌，可以点击左下角的 新建访问令牌 按钮</Callout>
  <img style={{ margin: '10px 0'}} src="/images/modelscope/step-3.png" alt="第三步：复制访问令牌" />

<Callout type="info">配置完成后，需要重启服务才会生效喔~</Callout>
  <img style={{ margin: '10px 0'}} src="/images/modelscope/step-4.png" alt="第四步：填入访问令牌，并点击 保存 按钮" />
