...
import type { IndependentConnectionOptions } from "./index";
import { IndependentXiaozhiConnectionManager } from "./index";
...
// 导出新管理器类型（便于直接使用）
export type { IndependentXiaozhiConnectionManager } from "./index";
