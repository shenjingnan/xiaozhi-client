/**
 * 工具验证器
 * 负责验证工具配置、工作流数据、JSON Schema 等的完整性
 */
...
const LETTER_START_REGEX = /^[a-zA-Z]/;
...
export class ToolValidator {
  ...
  validateGeneratedTool(tool: CustomMCPTool): void {
    ...
    // JSON Schema验证
    this.validateJsonSchema(tool.inputSchema as JSONSchema);
   ...
   * 验证服务和工具是否存在
   */
  validateServiceAndToolExistence(serverName: string, toolName: string): void {
    // 检查服务是否存在
